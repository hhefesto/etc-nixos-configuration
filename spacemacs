  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(a ace-link aggressive-indent all-the-icons auto-compile auto-highlight-symbol
         auto-yasnippet avy-jump-helm-line centered-cursor-mode clean-aindent-mode
         closql code-review column-enforce-mode company company-nixos-options
         company-shell deferred define-word devdocs diminish dired-quick-sort
         direnv disable-mouse dotenv-mode drag-stuff dumb-jump elisp-def
         elisp-demos elisp-slime-nav emacsql emojify emr envrc eval-sexp-fu
         ...
         helm-descbinds helm-ls-git helm-make helm-mode-manager helm-nixos-options
         helm-org helm-projectile helm-purpose helm-swoop helm-xref hide-comnt
         highlight-indentation highlight-numbers highlight-parentheses hl-todo
         holy-mode hungry-delete hybrid-mode indent-guide info+ inheritenv
         insert-shebang inspector link-hint llama lorem-ipsum lsp-mode macrostep
         magit magit-section markdown-mode multi-line nameless nix-mode
         nixos-options open-junk-file org-superstar origami overseer package-lint
         page-break-lines paradox password-generator pcre2el popwin pos-tip
         quickrun rainbow-delimiters reformatter restart-emacs shfmt smeargle
